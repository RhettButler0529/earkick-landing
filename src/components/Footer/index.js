    ...
    <>
      <div className="main-footer">
        <div className='main-footer-social'>
          <Link to={"/"}><img src={FACEBOOKICON} alt="facebook" width={'20px'}/></Link>
          <Link to={"/"}><img src={TWITTERICON} alt="twitter" width={'20px'}/></Link>
          <Link to={"/"}><img src={INSTAGRAMICON} alt="instagram" width={'20px'}/></Link>
        </div>
